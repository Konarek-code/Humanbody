  ...
  const [items, setItems] = useState([
    {
      ...
      visible: true,
      lvl: charmander,
      vid: 'https://www.youtube.com/watch?v=Y3H17rshgZE',
    ...
    },
    {
      ...
      visible: true,
      lvl: charmander,
      vid: 'https://www.youtube.com/watch?v=0BT533ueEdI',
      text: 'One arm lat pulldown'
    },
    {
      id: 3,
      src: checkbutt,
      ...
      visible: true,
      lvl: charmelon,
      vid: 'https://www.youtube.com/watch?v=u36Ln61hBD8',
      text: 'Chin ups - dead stop'
    },
    {
      id: 4,
      src: checkbutt,
      ...
      visible: true,
      lvl: charizard,
      vid: 'https://www.youtube.com/watch?v=KqbGIs16oAk',
      text: 'Seal row'
    },
    {
      id: 5,
      ...
      visible: true,
      lvl: charmelon,
      vid: 'https://www.youtube.com/watch?v=JRYViMt98a8',
      text: 'Dumbbell row – hand supported on bench'
    },
    {
      id: 6,
      src: checkbutt,
      ...
      visible: true,
      lvl: charmelon,
      vid: 'https://www.youtube.com/watch?v=vT2GjY_Umpw',
